...
equation
  ...
  connect(addPar.y, add2.u2)
    annotation (Line(points={{61,-20},{70,-20},{70,0},{-90,0},{-90,24},
      {-82,24}}, color={0,0,127}));
  ...
  connect(chiWatFloRat.y, add2.u1)
    annotation (Line(points={{-99,60},{-90,60},{-90,36},{-82,36}}, color={0,0,127}));
  ...
  connect(enaNexLag.y, yNexLagPum)
    annotation (Line(points={{121,30},{150,30}}, color={255,0,255}));
