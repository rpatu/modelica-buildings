within Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pump.ChilledWaterP;
...
equation
  ...
  connect(mulOr.y, not1.u)
    annotation (Line(points={{-98.3,-60},{-82,-60}}, color={255,0,255}));
  ...
  connect(one.y, pumSpe.x2)
    annotation (Line(points={{21,30},{40,30},{40,76},{98,76}}, color={0,0,127}));
