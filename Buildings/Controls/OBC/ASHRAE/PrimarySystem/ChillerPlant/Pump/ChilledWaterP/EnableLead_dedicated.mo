...
block EnableLead_dedicated
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys(uLow=offTimThr - 5, uHigh=offTimThr + 5)
...
equation
  ...
  connect(uLeaChiEna, leaPumSta.u)
    annotation (Line(points={{-120,40},{59,40}}, color={255,0,255}));
  connect(leaPumSta.y, yLeaPum)
    annotation (Line(points={{81,40},{110,40}}, color={255,0,255}));
  ...
  connect(not1.y, or2.u2)
    annotation (Line(points={{-59,-80},{30,-80},{30,-28},{38,-28}}, color={255,0,255}));
  connect(or2.y, leaPumSta.u0)
    annotation (Line(points={{61,-20},{70,-20},{70,20},{40,20},{40,34},{59,34}},
      color={255,0,255}));
...
<p>
The primary chilled water pump should be enabled when lead chiller is commanded 
