...
equation
  ...
  connect(zer.y, CWRTSpd.x1) annotation (Line(points={{21,80},{40,80},{40,48},{58,
          48}}, color={0,0,127}));
  connect(minSpe.y, CWRTSpd.f1) annotation (Line(points={{-39,80},{-20,80},{-20,
          44},{58,44}}, color={0,0,127}));
  connect(one.y, CWRTSpd.x2) annotation (Line(points={{21,20},{40,20},{40,36},{58,
          36}}, color={0,0,127}));
  connect(one.y, CWRTSpd.f2) annotation (Line(points={{21,20},{40,20},{40,32},{58,
          32}}, color={0,0,127}));
  ...
  connect(noProOn.y, conPID.trigger)
    annotation (Line(points={{21,-20},{40,-20},{40,0},{-58,0},{-58,28}},
      color={255,0,255}));
  connect(proOn.y, anyProOn.u)
    annotation (Line(points={{-59,-20},{-42,-20}}, color={255,0,255}));
  connect(CWRTSpd.y, fanSpe.u[1]) annotation (Line(points={{81,40},{90,40},{90,
  ...
  connect(maxSpe.y, fanSpe.u[2])
    annotation (Line(points={{-59,-60},{58,-60}}, color={0,0,127}));
