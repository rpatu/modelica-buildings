...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant towTemSet(
    final k=TTowSet - 1*5/9)
    "Tower temperature setpoint minus 1 degF"
    annotation (Placement(transformation(extent={{-140,30},{-120,50}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant one[nChi](
    each final k=1) "Constant one"
    annotation (Placement(transformation(extent={{-140,120},{-120,140}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant towTemSet1(
    final k=TTowSet + 1*5/9)
    "Tower temperature setpoint plus 1 degF"
...
equation
  ...
  connect(towTemSet.y, feedback2.u1)
    annotation (Line(points={{-119,40},{-92,40}}, color={0,0,127}));
  connect(TTow, feedback2.u2)
    annotation (Line(points={{-200,20},{-80,20},{-80,28}}, color={0,0,127}));
  ...
  connect(TTow, feedback3.u1)
    annotation (Line(points={{-200,20},{-120,20},{-120,-40},{-92,-40}},
      color={0,0,127}));
  connect(towTemSet1.y, feedback3.u2)
    annotation (Line(points={{-119,-80},{-80,-80},{-80,-52}}, color={0,0,127}));
