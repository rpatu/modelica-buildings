...
equation
  ...
  connect(anyProOn.y,noProOn. u)
    annotation (Line(points={{-18.3,20},{-2,20}},   color={255,0,255}));
  ...
  connect(zer.y, supTemSet.x1) annotation (Line(points={{21,140},{40,140},{40,118},
          {58,118}}, color={0,0,127}));
  connect(TConWatRetSet, addPar.u) annotation (Line(points={{-120,110},{-80,110},
          {-80,140},{-62,140}}, color={0,0,127}));
  connect(addPar.y, supTemSet.f1) annotation (Line(points={{-39,140},{-20,140},{
          -20,114},{58,114}}, color={0,0,127}));
  connect(conPID.y, supTemSet.u)
    annotation (Line(points={{-39,110},{58,110}}, color={0,0,127}));
  connect(one.y, supTemSet.x2) annotation (Line(points={{1,90},{20,90},{20,106},
          {58,106}}, color={0,0,127}));
  connect(addPar1.y, supTemSet.f2) annotation (Line(points={{1,60},{40,60},{40,102},
          {58,102}}, color={0,0,127}));
  connect(uConWatPumSpe, proOn.u)
    annotation (Line(points={{-120,20},{-82,20}}, color={0,0,127}));
  connect(noProOn.y, conPID.trigger) annotation (Line(points={{21,20},{40,20},{40,
          40},{-58,40},{-58,98}}, color={255,0,255}));
  connect(supTemSet.y, conPID1.u_s) annotation (Line(points={{81,110},{90,110},{
          90,-10},{-80,-10},{-80,-60},{-62,-60}}, color={0,0,127}));
  connect(zer1.y, CWSTSpd.x1) annotation (Line(points={{21,-30},{40,-30},{40,-52},
          {58,-52}}, color={0,0,127}));
  connect(minSpe.y, CWSTSpd.f1) annotation (Line(points={{-39,-30},{-20,-30},{-20,
  ...
  connect(uMaxTowSpeSet,maxSpe. u)
    annotation (Line(points={{-120,-120},{-82,-120}},
                                                    color={0,0,127}));
  connect(CWSTSpd.y, fanSpe.u[1]) annotation (Line(points={{81,-60},{90,-60},{
          90,-90},{40,-90},{40,-118.667},{58,-118.667}},
                                                      color={0,0,127}));
  connect(maxSpe.y, fanSpe.u[2])
    annotation (Line(points={{-59,-120},{58,-120}}, color={0,0,127}));
