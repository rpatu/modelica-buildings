...
equation
  ...
  connect(chiMinCycLoa.y, swi.u1)
    annotation (Line(points={{-99,140},{-80,140},{-80,108},{-62,108}}, color={0,0,127}));
  connect(zer.y, swi.u3)
    annotation (Line(points={{-99,80},{-80,80},{-80,92},{-62,92}}, color={0,0,127}));
  connect(minCycLoa.y, div.u2)
    annotation (Line(points={{1,140},{20,140},{20,94},{38,94}}, color={0,0,127}));
  connect(minCycLoa.y, div1.u2)
    annotation (Line(points={{1,140},{20,140},{20,54},{38,54}}, color={0,0,127}));
  connect(totLoa.y, div1.u1)
    annotation (Line(points={{1,60},{10,60},{10,66},{38,66}}, color={0,0,127}));
  connect(totMinCycLoa.y, div.u1)
    annotation (Line(points={{1,100},{10,100},{10,106},{38,106}}, color={0,0,127}));
  connect(div.y, loaCon.u_s)
    annotation (Line(points={{61,100},{78,100}}, color={0,0,127}));
  connect(div1.y, loaCon.u_m)
    annotation (Line(points={{61,60},{90,60},{90,88}}, color={0,0,127}));
  connect(mulOr.y, and2.u1)
    annotation (Line(points={{-98.3,20},{-62,20}}, color={255,0,255}));
  ...
  connect(not1.y, loaCon.trigger)
    annotation (Line(points={{1,20},{82,20},{82,88}}, color={255,0,255}));
  connect(loaCon.y, lin.u)
    annotation (Line(points={{101,100},{120,100},{120,0},{40,0},{40,-40},{58,-40}},
      color={0,0,127}));
  connect(zer1.y, lin.x1)
    annotation (Line(points={{21,-20},{30,-20},{30,-32},{58,-32}}, color={0,0,127}));
  connect(minTowSpe.y, lin.f1)
    annotation (Line(points={{-19,-20},{-10,-20},{-10,-36},{58,-36}}, color={0,0,127}));
  connect(maxTowSpe.y, lin.f2)
    annotation (Line(points={{21,-60},{30,-60},{30,-48},{58,-48}}, color={0,0,127}));
  connect(one.y, lin.x2)
    annotation (Line(points={{-19,-60},{-10,-60},{-10,-44},{58,-44}}, color={0,0,127}));
  connect(mulOr.y, edg.u)
    annotation (Line(points={{-98.3,20},{-90,20},{-90,-140},{-62,-140}}, color={255,0,255}));
  connect(uWSE, and1.u1)
    annotation (Line(points={{-180,0},{-80,0},{-80,-120},{-2,-120}}, color={255,0,255}));
  connect(edg.y, and1.u2)
    annotation (Line(points={{-39,-140},{-20,-140},{-20,-128},{-2,-128}}, color={255,0,255}));
  connect(and1.y, lat.u)
    annotation (Line(points={{21,-120},{39,-120}}, color={255,0,255}));
  connect(lat.y, intOpeTim.u)
    annotation (Line(points={{61,-120},{78,-120}}, color={255,0,255}));
  ...
  connect(lat.y, fanSpe.u2)
    annotation (Line(points={{61,-120},{70,-120},{70,-80},{118,-80}}, color={255,0,255}));
  connect(lin.y, fanSpe.u3)
    annotation (Line(points={{81,-40},{100,-40},{100,-88},{118,-88}}, color={0,0,127}));
  connect(maxTowSpe.y, fanSpe.u1)
    annotation (Line(points={{21,-60},{30,-60},{30,-72},{118,-72}}, color={0,0,127}));
  connect(fanSpe.y, yTowSpe)
    annotation (Line(points={{141,-80},{170,-80}}, color={0,0,127}));
  connect(chiMinCycLoa.y, minCycLoa.u)
    annotation (Line(points={{-99,140},{-22,140}}, color={0,0,127}));
