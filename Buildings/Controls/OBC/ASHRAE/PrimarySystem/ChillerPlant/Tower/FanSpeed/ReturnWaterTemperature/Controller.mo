...
block Controller
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uTowSpe(
    ...
    annotation (Placement(transformation(extent={{-200,-10},{-160,30}}),
      iconTransformation(extent={{-220,20},{-200,40}})));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput uConWatPumNum(
    ...
    annotation (Placement(transformation(extent={{-200,-100},{-160,-60}}),
      iconTransformation(extent={{-220,-40},{-200,-20}})));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uConWatPumSpe[nConWatPum](
    ...
    annotation (Placement(transformation(extent={{-200,-260},{-160,-220}}),
      iconTransformation(extent={{-220,-160},{-200,-140}})));
...
equation
  ...
  connect(mulOr.y, and2.u1)
    annotation (Line(points={{-98.3,210},{-22,210}},  color={255,0,255}));
  connect(not1.y, and2.u2) annotation (Line(points={{-99,170},{-90,170},{-90,202},
          {-22,202}},      color={255,0,255}));
  connect(reqPlaCap, parLoaRat.u)
    annotation (Line(points={{-180,110},{-122,110}}, color={0,0,127}));
  connect(zer.y, plrTowMaxSpe.x1) annotation (Line(points={{-39,140},{-30,140},{
          -30,118},{-22,118}}, color={0,0,127}));
  connect(lowPlrTowMaxSpe.y, plrTowMaxSpe.f1) annotation (Line(points={{-99,140},
          {-70,140},{-70,114},{-22,114}}, color={0,0,127}));
  connect(parLoaRat.y, plrTowMaxSpe.u)
    annotation (Line(points={{-99,110},{-22,110}}, color={0,0,127}));
  connect(hal.y, plrTowMaxSpe.x2) annotation (Line(points={{-99,80},{-70,80},{-70,
          106},{-22,106}}, color={0,0,127}));
  connect(uppPlrTowMaxSpe.y, plrTowMaxSpe.f2) annotation (Line(points={{-39,80},
  ...
  connect(parLoaRat.y, conWatRetSet.plaParLoaRat) annotation (Line(points={{-99,110},
  ...
  connect(plrTowMaxSpe.y, couTowSpe.plrTowMaxSpe) annotation (Line(points={{1,110},
          {20,110},{20,-138},{38,-138}}, color={0,0,127}));
  connect(conWatRetSet.TConWatRetSet, lesCouTowSpe.TConWatRetSet) annotation (
      Line(points={{61,-70},{80,-70},{80,-100},{26,-100},{26,-200},{38,-200}},
        color={0,0,127}));
  ...
  connect(plrTowMaxSpe.y, lesCouTowSpe.plrTowMaxSpe) annotation (Line(points={{1,110},
  ...
  connect(lesCouTowSpe.yTowSpe, swi.u1) annotation (Line(points={{61,-210},{100,
  ...
  connect(tru.y, and2.u2) annotation (Line(points={{-59,170},{-40,170},{-40,202},
          {-22,202}}, color={255,0,255}));
  connect(and2.y, swi1.u2)
    annotation (Line(points={{1,210},{98,210}}, color={255,0,255}));
  connect(swi.y, swi1.u1) annotation (Line(points={{141,0},{150,0},{150,190},{60,
          190},{60,218},{98,218}}, color={0,0,127}));
  connect(uTowSpeWSE, swi1.u3) annotation (Line(points={{-180,240},{80,240},{80,
          202},{98,202}}, color={0,0,127}));
  connect(zer2.y, swi1.u3) annotation (Line(points={{61,170},{80,170},{80,202},{
          98,202}}, color={0,0,127}));
  connect(swi1.y, yTowSpe)
    annotation (Line(points={{121,210},{170,210}}, color={0,0,127}));
  connect(uChi, mulOr.u)
    annotation (Line(points={{-180,210},{-122,210}}, color={255,0,255}));
  connect(con.y, TTowSet.u2) annotation (Line(points={{-59,50},{-22,50}},
                     color={255,0,255}));
  connect(con.y, TTow.u2) annotation (Line(points={{-59,50},{-40,50},{-40,-10},{
          -22,-10}},  color={255,0,255}));
  connect(TConWatRet, TTow.u1) annotation (Line(points={{-180,-200},{-114,-200},
          {-114,-2},{-22,-2}}, color={0,0,127}));
  connect(conWatRetSet.TConWatRetSet, TTowSet.u1) annotation (Line(points={{61,-70},
  ...
  connect(lesCouTowSpe.TConWatSupSet, TTowSet.u3) annotation (Line(points={{61,-202},
          {80,-202},{80,-160},{-46,-160},{-46,42},{-22,42}}, color={0,0,127}));
  connect(TTowSet.y, enaTow.TTowSet) annotation (Line(points={{1,50},{10,50},{10,
          22},{38,22}}, color={0,0,127}));
  connect(TTow.y, enaTow.TTow) annotation (Line(points={{1,-10},{10,-10},{10,18},
          {38,18}}, color={0,0,127}));
  connect(dumTem.y, TTowSet.u3) annotation (Line(points={{-59,-40},{-46,-40},{-46,
          42},{-22,42}}, color={0,0,127}));
  connect(dumTem.y, TTow.u3) annotation (Line(points={{-59,-40},{-40,-40},{-40,-18},
          {-22,-18}}, color={0,0,127}));
