...
equation
  ...
  connect(minSpe.y, feedback1.u2)
    annotation (Line(points={{-99,60},{-80,60},{-80,68}}, color={0,0,127}));
  connect(feedback1.y, hys2.u)
    annotation (Line(points={{-69,80},{-42,80}}, color={0,0,127}));
  ...
  connect(hys1.y, not1.u)
    annotation (Line(points={{-19,120},{-2,120}}, color={255,0,255}));
  connect(feedback2.y, hys1.u)
    annotation (Line(points={{-89,-40},{-60,-40},{-60,120},{-42,120}}, color={0,0,127}));
  connect(not1.y, and2.u1)
    annotation (Line(points={{21,120},{38,120}}, color={255,0,255}));
  connect(not2.y, and2.u2)
    annotation (Line(points={{21,80},{30,80},{30,112},{38,112}}, color={255,0,255}));
  connect(and2.y, tim.u)
    annotation (Line(points={{61,120},{78,120}}, color={255,0,255}));
  connect(tim.y, greEquThr.u)
    annotation (Line(points={{101,120},{110,120},{110,100},{60,100},{60,80},{78,80}},
      color={0,0,127}));
  connect(greEquThr.y, edg.u)
    annotation (Line(points={{101,80},{110,80},{110,60},{-50,60},{-50,0},{-42,0}},
      color={255,0,255}));
  connect(edg.y, lat.u)
    annotation (Line(points={{-19,0},{-1,0}}, color={255,0,255}));
  connect(zer.y, swi.u1)
    annotation (Line(points={{21,40},{80,40},{80,8},{98,8}}, color={0,0,127}));
  connect(lat.y, swi.u2)
    annotation (Line(points={{21,0},{98,0}}, color={255,0,255}));
  connect(feedback2.y, hys3.u)
    annotation (Line(points={{-89,-40},{-42,-40}}, color={0,0,127}));
  ...
  connect(lat.y, chiWatTemCon.trigger)
    annotation (Line(points={{21,0},{40,0},{40,-60},{-80,-60},{-80,-120},
      {-58,-120},{-58,-112}}, color={255,0,255}));
  connect(zer1.y, lin.x1)
    annotation (Line(points={{41,-80},{60,-80},{60,-92},{78,-92}}, color={0,0,127}));
  connect(minSpe1.y, lin.f1)
    annotation (Line(points={{1,-80},{10,-80},{10,-96},{78,-96}}, color={0,0,127}));
  connect(chiWatTemCon.y, lin.u)
    annotation (Line(points={{-39,-100},{78,-100}}, color={0,0,127}));
  connect(one.y, lin.x2)
    annotation (Line(points={{1,-120},{10,-120},{10,-104},{78,-104}}, color={0,0,127}));
  connect(maxSpe.y, lin.f2)
    annotation (Line(points={{41,-120},{60,-120},{60,-108},{78,-108}}, color={0,0,127}));
  connect(lin.y, swi.u3)
    annotation (Line(points={{101,-100},{120,-100},{120,-40},{80,-40},
      {80,-8},{98,-8}}, color={0,0,127}));
