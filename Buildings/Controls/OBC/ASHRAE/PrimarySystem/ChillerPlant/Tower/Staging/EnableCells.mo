...
equation
  connect(con2.y, towCelOn.u)
    annotation (Line(points={{-339,460},{-322,460}}, color={0,0,127}));
  connect(uWSE,swi. u2)
    annotation (Line(points={{-500,360},{-382,360}},color={255,0,255}));
  connect(addPar.y,swi. u1)
    annotation (Line(points={{-359,420},{-340,420},{-340,390},{-400,390},{-400,368},
      {-382,368}}, color={0,0,127}));
  connect(swi.y,pumSpeSta. u)
    annotation (Line(points={{-359,360},{-342,360}}, color={0,0,127}));
  connect(uChiSta,intToRea. u)
    annotation (Line(points={{-500,460},{-422,460}}, color={255,127,0}));
  connect(intToRea.y,addPar1. u)
    annotation (Line(points={{-399,460},{-380,460},{-380,440},{-440,440},{-440,420},
      {-422,420}}, color={0,0,127}));
  connect(addPar1.y,addPar. u)
    annotation (Line(points={{-399,420},{-382,420}}, color={0,0,127}));
  connect(addPar1.y,swi. u3)
    annotation (Line(points={{-399,420},{-390,420},{-390,352},{-382,352}},
      color={0,0,127}));
  connect(towCelOn.y, reaToInt.u)
    annotation (Line(points={{-299,460},{-282,460}}, color={0,0,127}));
  connect(pumSpeSta.y, towCelOn.index)
    annotation (Line(points={{-319,360},{-310,360},{-310,448}}, color={255,127,0}));
  ...
  connect(mulSum.y, reaToInt1.u)
    annotation (Line(points={{-359,300},{-342,300}}, color={0,0,127}));
  connect(reaToInt.y, addInt.u1)
    annotation (Line(points={{-259,460},{-240,460},{-240,366},{-222,366}},
      color={255,127,0}));
  connect(reaToInt1.y, addInt.u2)
    annotation (Line(points={{-319,300},{-240,300},{-240,354},{-222,354}},
      color={255,127,0}));
  connect(uTowCelPri, intToRea2.u)
    annotation (Line(points={{-500,-140},{-422,-140}}, color={255,127,0}));
  connect(conInt1.y, intEqu.u2)
    annotation (Line(points={{-199,330},{-160,330},{-160,352},{-142,352}},
      color={255,127,0}));
  connect(addInt.y, intEqu.u1)
    annotation (Line(points={{-199,360},{-142,360}}, color={255,127,0}));
  connect(mulSum.y, addPar2.u)
    annotation (Line(points={{-359,300},{-350,300},{-350,-160},{-342,-160}},
      color={0,0,127}));
  connect(addPar2.y, reaToInt2.u)
    annotation (Line(points={{-319,-160},{-302,-160}}, color={0,0,127}));
  connect(intToRea2.y, nexTowCel.u)
    annotation (Line(points={{-399,-140},{-242,-140}}, color={0,0,127}));
  connect(reaToInt2.y, nexTowCel.index)
    annotation (Line(points={{-279,-160},{-230,-160},{-230,-152}},
      color={255,127,0}));
  connect(nexTowCel.y, reaToInt3.u)
    annotation (Line(points={{-219,-140},{-182,-140}}, color={0,0,127}));
  connect(reaToInt3.y, intRep.u)
    annotation (Line(points={{-159,-140},{-142,-140}}, color={255,127,0}));
  connect(conInt.y, intEqu1.u2)
    annotation (Line(points={{-399,-100},{-100,-100},{-100,-148},{-82,-148}},
      color={255,127,0}));
  connect(intRep.y, intEqu1.u1)
    annotation (Line(points={{-119,-140},{-82,-140}},color={255,127,0}));
  connect(intEqu1.y, logSwi.u2)
    annotation (Line(points={{-59,-140},{-2,-140}}, color={255,0,255}));
  connect(con.y, logSwi.u1)
    annotation (Line(points={{-59,-100},{-20,-100},{-20,-132},{-2,-132}},
      color={255,0,255}));
  ...
  connect(mulSum.y, addPar3.u)
    annotation (Line(points={{-359,300},{-350,300},{-350,-210},{-342,-210}},
      color={0,0,127}));
  connect(addPar3.y, reaToInt5.u)
    annotation (Line(points={{-319,-210},{-302,-210}}, color={0,0,127}));
  connect(reaToInt5.y, nexTowCel1.index)
    annotation (Line(points={{-279,-210},{-230,-210},{-230,-202}},
      color={255,127,0}));
  connect(intToRea2.y, nexTowCel1.u)
    annotation (Line(points={{-399,-140},{-380,-140},{-380,-190},{-242,-190}},
      color={0,0,127}));
  connect(nexTowCel1.y, reaToInt4.u)
    annotation (Line(points={{-219,-190},{-182,-190}}, color={0,0,127}));
  connect(reaToInt4.y, intRep1.u)
    annotation (Line(points={{-159,-190},{-142,-190}}, color={255,127,0}));
  connect(intRep1.y, intEqu2.u1)
    annotation (Line(points={{-119,-190},{-82,-190}},color={255,127,0}));
  connect(conInt.y, intEqu2.u2)
    annotation (Line(points={{-399,-100},{-100,-100},{-100,-198},{-82,-198}},
      color={255,127,0}));
  connect(intEqu2.y, logSwi1.u2)
    annotation (Line(points={{-59,-190},{-2,-190}}, color={255,0,255}));
  connect(con.y, logSwi1.u1)
    annotation (Line(points={{-59,-100},{-20,-100},{-20,-182},{-2,-182}},
      color={255,0,255}));
  connect(uTowSta, logSwi1.u3) annotation (Line(points={{-500,300},{-440,300},{-440,
          -80},{-40,-80},{-40,-198},{-2,-198}}, color={255,0,255}));
  connect(mulSum.y, reaToInt6.u) annotation (Line(points={{-359,300},{-350,300},
          {-350,-260},{-302,-260}}, color={0,0,127}));
  connect(reaToInt6.y, nexTowCel3.index) annotation (Line(points={{-279,-260},{-230,
          -260},{-230,-252}}, color={255,127,0}));
  connect(nexTowCel3.y, reaToInt8.u)
    annotation (Line(points={{-219,-240},{-182,-240}}, color={0,0,127}));
  connect(reaToInt8.y, intRep3.u)
    annotation (Line(points={{-159,-240},{-142,-240}}, color={255,127,0}));
  connect(intRep3.y, intEqu3.u1)
    annotation (Line(points={{-119,-240},{-82,-240}},color={255,127,0}));
  connect(conInt.y, intEqu3.u2) annotation (Line(points={{-399,-100},{-100,-100},
          {-100,-248},{-82,-248}},color={255,127,0}));
  connect(intEqu3.y, logSwi3.u2)
    annotation (Line(points={{-59,-240},{-2,-240}}, color={255,0,255}));
  connect(intToRea2.y, nexTowCel3.u) annotation (Line(points={{-399,-140},{-380,
          -140},{-380,-240},{-242,-240}}, color={0,0,127}));
  connect(mulSum.y, addPar5.u) annotation (Line(points={{-359,300},{-350,300},{-350,
          -310},{-342,-310}}, color={0,0,127}));
  connect(addPar5.y, reaToInt7.u)
    annotation (Line(points={{-319,-310},{-302,-310}}, color={0,0,127}));
  connect(reaToInt7.y, nexTowCel2.index) annotation (Line(points={{-279,-310},{-230,
          -310},{-230,-302}}, color={255,127,0}));
  connect(intToRea2.y, nexTowCel2.u) annotation (Line(points={{-399,-140},{-380,
          -140},{-380,-290},{-242,-290}}, color={0,0,127}));
  connect(nexTowCel2.y, reaToInt9.u)
    annotation (Line(points={{-219,-290},{-182,-290}}, color={0,0,127}));
  connect(reaToInt9.y, intRep2.u)
    annotation (Line(points={{-159,-290},{-142,-290}}, color={255,127,0}));
  connect(intRep2.y, intEqu4.u1)
    annotation (Line(points={{-119,-290},{-82,-290}},color={255,127,0}));
  connect(conInt.y, intEqu4.u2) annotation (Line(points={{-399,-100},{-100,-100},
          {-100,-298},{-82,-298}},color={255,127,0}));
  connect(intEqu4.y, logSwi2.u2)
    annotation (Line(points={{-59,-290},{-2,-290}}, color={255,0,255}));
  ...
  connect(con1.y, logSwi3.u1) annotation (Line(points={{-59,-330},{-20,-330},{-20,
          -232},{-2,-232}}, color={255,0,255}));
  connect(con1.y, logSwi2.u1) annotation (Line(points={{-59,-330},{-20,-330},{-20,
  ...
  connect(logSwi.y, or3.u2) annotation (Line(points={{21,-140},{40,-140},{40,-120},
          {78,-120}}, color={255,0,255}));
  connect(logSwi1.y, or3.u3) annotation (Line(points={{21,-190},{60,-190},{60,-128},
          {78,-128}}, color={255,0,255}));
  connect(uTowSta, or2.u1) annotation (Line(points={{-500,300},{-440,300},{-440,
          -80},{78,-80}}, color={255,0,255}));
  connect(logSwi.y, or2.u2) annotation (Line(points={{21,-140},{40,-140},{40,-88},
  ...
  connect(logSwi3.y, and7.u1) annotation (Line(points={{21,-240},{60,-240},{60,-302},
          {78,-302}}, color={255,0,255}));
  connect(logSwi2.y, and7.u3) annotation (Line(points={{21,-290},{40,-290},{40,-318},
          {78,-318}}, color={255,0,255}));
  connect(uTowSta, and8.u2) annotation (Line(points={{-500,300},{-440,300},{-440,
          -80},{-40,-80},{-40,-268},{78,-268}}, color={255,0,255}));
  connect(logSwi3.y, and8.u1) annotation (Line(points={{21,-240},{60,-240},{60,-260},
          {78,-260}}, color={255,0,255}));
  connect(addInt.y, intEqu5.u1) annotation (Line(points={{-199,360},{-180,360},{
          -180,250},{-142,250}}, color={255,127,0}));
  connect(conInt2.y, intEqu5.u2) annotation (Line(points={{-199,230},{-160,230},
          {-160,242},{-142,242}}, color={255,127,0}));
  connect(addInt.y, intEqu6.u1) annotation (Line(points={{-199,360},{-180,360},{
          -180,140},{-142,140}}, color={255,127,0}));
  connect(conInt3.y, intEqu6.u2) annotation (Line(points={{-199,120},{-160,120},
          {-160,132},{-142,132}}, color={255,127,0}));
  connect(addInt.y, intEqu7.u1) annotation (Line(points={{-199,360},{-180,360},{
          -180,30},{-142,30}}, color={255,127,0}));
  connect(conInt4.y, intEqu7.u2) annotation (Line(points={{-199,10},{-160,10},{-160,
          22},{-142,22}}, color={255,127,0}));
  ...
  connect(edg.y, and9.u1)
    annotation (Line(points={{-199,400},{-42,400}}, color={255,0,255}));
  connect(intEqu.y, and9.u2) annotation (Line(points={{-119,360},{-100,360},{-100,
          392},{-42,392}}, color={255,0,255}));
  connect(and9.y, lat2.u)
    annotation (Line(points={{-19,400},{39,400}}, color={255,0,255}));
  connect(addInt.y, intEqu8.u1) annotation (Line(points={{-199,360},{-180,360},{
          -180,-20},{-142,-20}}, color={255,127,0}));
  connect(conInt5.y, intEqu8.u2) annotation (Line(points={{-199,-30},{-180,-30},
          {-180,-28},{-142,-28}}, color={255,127,0}));
  connect(intEqu8.y, edg1.u)
    annotation (Line(points={{-119,-20},{-62,-20}},color={255,0,255}));
  connect(edg1.y, lat2.u0) annotation (Line(points={{-39,-20},{20,-20},{20,394},
          {39,394}}, color={255,0,255}));
  connect(intEqu5.y, and10.u2) annotation (Line(points={{-119,250},{-100,250},{-100,
          272},{-42,272}}, color={255,0,255}));
  connect(edg.y, and10.u1) annotation (Line(points={{-199,400},{-80,400},{-80,280},
          {-42,280}}, color={255,0,255}));
  connect(and10.y, lat3.u)
    annotation (Line(points={{-19,280},{39,280}}, color={255,0,255}));
  connect(edg1.y, lat3.u0) annotation (Line(points={{-39,-20},{20,-20},{20,274},
          {39,274}}, color={255,0,255}));
  connect(falEdg2.y, and12.u1) annotation (Line(points={{-199,430},{-60,430},{-60,
          170},{-42,170}}, color={255,0,255}));
  connect(falEdg2.y, and11.u1) annotation (Line(points={{-199,430},{-60,430},{-60,
          60},{-42,60}}, color={255,0,255}));
  connect(intEqu6.y, and12.u2) annotation (Line(points={{-119,140},{-100,140},{-100,
          162},{-42,162}}, color={255,0,255}));
  connect(intEqu7.y, and11.u2) annotation (Line(points={{-119,30},{-100,30},{-100,
          52},{-42,52}}, color={255,0,255}));
  connect(and12.y, lat4.u)
    annotation (Line(points={{-19,170},{39,170}}, color={255,0,255}));
  connect(and11.y, lat5.u)
    annotation (Line(points={{-19,60},{39,60}}, color={255,0,255}));
  ...
  connect(cha1.up, and13.u1) annotation (Line(points={{-199,486},{10,486},{10,430},
          {38,430}}, color={255,0,255}));
  connect(intEqu.y, and13.u2) annotation (Line(points={{-119,360},{-100,360},{-100,
          422},{38,422}}, color={255,0,255}));
  connect(and13.y, lat6.u)
    annotation (Line(points={{61,430},{99,430}},  color={255,0,255}));
  connect(edg1.y, lat6.u0) annotation (Line(points={{-39,-20},{80,-20},{80,424},
          {99,424}},  color={255,0,255}));
  connect(cha1.up, and14.u1) annotation (Line(points={{-199,486},{10,486},{10,310},
          {38,310}}, color={255,0,255}));
  connect(intEqu5.y, and14.u2) annotation (Line(points={{-119,250},{-100,250},{-100,
          302},{38,302}}, color={255,0,255}));
  connect(and14.y, lat7.u)
    annotation (Line(points={{61,310},{99,310}},  color={255,0,255}));
  connect(edg1.y, lat7.u0) annotation (Line(points={{-39,-20},{80,-20},{80,304},
          {99,304}},  color={255,0,255}));
  connect(cha1.down, and15.u1) annotation (Line(points={{-199,474},{0,474},{0,200},
          {38,200}},      color={255,0,255}));
  connect(intEqu6.y, and15.u2) annotation (Line(points={{-119,140},{-100,140},{-100,
          192},{38,192}}, color={255,0,255}));
  connect(and15.y, lat8.u)
    annotation (Line(points={{61,200},{99,200}},  color={255,0,255}));
  connect(edg1.y, lat8.u0) annotation (Line(points={{-39,-20},{80,-20},{80,194},
          {99,194}},  color={255,0,255}));
  connect(intEqu7.y, and16.u2) annotation (Line(points={{-119,30},{-100,30},{-100,
          82},{38,82}}, color={255,0,255}));
  connect(cha1.down, and16.u1) annotation (Line(points={{-199,474},{0,474},{0,90},
          {38,90}}, color={255,0,255}));
  connect(and16.y, lat9.u)
    annotation (Line(points={{61,90},{99,90}},  color={255,0,255}));
  connect(edg1.y, lat9.u0) annotation (Line(points={{-39,-20},{80,-20},{80,84},{
          99,84}},   color={255,0,255}));
  connect(and2.y, booRep1.u)
    annotation (Line(points={{-419,-360},{-342,-360}}, color={255,0,255}));
  connect(booRep1.y, logSwi4.u2) annotation (Line(points={{-319,-360},{240,-360},
          {240,450},{278,450}}, color={255,0,255}));
  connect(or2.y, logSwi4.u1) annotation (Line(points={{101,-80},{200,-80},{200,458},
          {278,458}}, color={255,0,255}));
  ...
  connect(lat6.y, booRep3.u)
    annotation (Line(points={{121,430},{138,430}}, color={255,0,255}));
  connect(booRep3.y, logSwi5.u2)
    annotation (Line(points={{161,430},{338,430}}, color={255,0,255}));
  connect(logSwi4.y, logSwi5.u1) annotation (Line(points={{301,450},{320,450},{320,
          438},{338,438}}, color={255,0,255}));
  connect(lat2.y, booRep4.u)
    annotation (Line(points={{61,400},{138,400}}, color={255,0,255}));
  connect(booRep4.y, logSwi6.u2)
    annotation (Line(points={{161,400},{278,400}}, color={255,0,255}));
  connect(or2.y, logSwi6.u1) annotation (Line(points={{101,-80},{200,-80},{200,408},
          {278,408}}, color={255,0,255}));
  connect(uTowSta, logSwi6.u3) annotation (Line(points={{-500,300},{-440,300},{-440,
          -80},{-40,-80},{-40,-60},{180,-60},{180,392},{278,392}}, color={255,0,
          255}));
  connect(logSwi6.y, logSwi5.u3) annotation (Line(points={{301,400},{320,400},{320,
          422},{338,422}}, color={255,0,255}));
  connect(logSwi5.y, logSwi7.u1) annotation (Line(points={{361,430},{370,430},{370,
          438},{398,438}}, color={255,0,255}));
  connect(intEqu.y, booRep5.u)
    annotation (Line(points={{-119,360},{-42,360}},color={255,0,255}));
  connect(booRep5.y, logSwi7.u2) annotation (Line(points={{-19,360},{380,360},{380,
          430},{398,430}}, color={255,0,255}));
  connect(lat7.y, booRep6.u)
    annotation (Line(points={{121,310},{138,310}}, color={255,0,255}));
  connect(lat3.y, booRep7.u)
    annotation (Line(points={{61,280},{138,280}}, color={255,0,255}));
  connect(booRep6.y, logSwi10.u2)
    annotation (Line(points={{161,310},{338,310}}, color={255,0,255}));
  connect(booRep1.y, logSwi9.u2) annotation (Line(points={{-319,-360},{240,-360},
          {240,330},{278,330}}, color={255,0,255}));
  connect(or3.y, logSwi9.u1) annotation (Line(points={{101,-120},{206,-120},{206,
          338},{278,338}}, color={255,0,255}));
  connect(uTowSta, logSwi9.u3) annotation (Line(points={{-500,300},{-440,300},{-440,
          -80},{-40,-80},{-40,-60},{180,-60},{180,322},{278,322}}, color={255,0,
          255}));
  connect(or3.y, logSwi8.u1) annotation (Line(points={{101,-120},{206,-120},{206,
          288},{278,288}}, color={255,0,255}));
  ...
  connect(booRep7.y, logSwi8.u2)
    annotation (Line(points={{161,280},{278,280}}, color={255,0,255}));
  connect(logSwi9.y, logSwi10.u1) annotation (Line(points={{301,330},{320,330},{
          320,318},{338,318}}, color={255,0,255}));
  connect(logSwi8.y, logSwi10.u3) annotation (Line(points={{301,280},{320,280},{
          320,302},{338,302}}, color={255,0,255}));
  connect(intEqu7.y, booRep9.u)
    annotation (Line(points={{-119,30},{-42,30}},color={255,0,255}));
  connect(intEqu6.y, booRep8.u)
    annotation (Line(points={{-119,140},{-42,140}},color={255,0,255}));
  connect(intEqu5.y, booRep2.u)
    annotation (Line(points={{-119,250},{-42,250}},color={255,0,255}));
  connect(logSwi10.y, logSwi11.u1) annotation (Line(points={{361,310},{370,310},
          {370,338},{398,338}}, color={255,0,255}));
  connect(booRep2.y, logSwi11.u2) annotation (Line(points={{-19,250},{380,250},{
          380,330},{398,330}}, color={255,0,255}));
  connect(logSwi11.y, logSwi7.u3) annotation (Line(points={{421,330},{440,330},{
          440,400},{388,400},{388,422},{398,422}}, color={255,0,255}));
  connect(lat8.y, booRep10.u)
    annotation (Line(points={{121,200},{138,200}}, color={255,0,255}));
  connect(lat4.y, booRep11.u)
    annotation (Line(points={{61,170},{138,170}}, color={255,0,255}));
  connect(booRep10.y, logSwi14.u2)
    annotation (Line(points={{161,200},{338,200}}, color={255,0,255}));
  connect(logSwi13.y, logSwi14.u1) annotation (Line(points={{301,220},{320,220},
          {320,208},{338,208}}, color={255,0,255}));
  connect(logSwi12.y, logSwi14.u3) annotation (Line(points={{301,170},{320,170},
          {320,192},{338,192}}, color={255,0,255}));
  connect(logSwi14.y, logSwi15.u1) annotation (Line(points={{361,200},{370,200},
          {370,228},{398,228}}, color={255,0,255}));
  connect(logSwi15.y, logSwi11.u3) annotation (Line(points={{421,220},{440,220},
          {440,300},{390,300},{390,322},{398,322}}, color={255,0,255}));
  connect(booRep8.y, logSwi15.u2) annotation (Line(points={{-19,140},{380,140},{
          380,220},{398,220}}, color={255,0,255}));
  connect(and1.y, booRep12.u)
    annotation (Line(points={{-419,-440},{-342,-440}}, color={255,0,255}));
  connect(booRep12.y, logSwi13.u2) annotation (Line(points={{-319,-440},{260,-440},
          {260,220},{278,220}}, color={255,0,255}));
  connect(and8.y, logSwi13.u1) annotation (Line(points={{101,-260},{212,-260},{212,
          228},{278,228}}, color={255,0,255}));
  connect(uTowSta, logSwi13.u3) annotation (Line(points={{-500,300},{-440,300},{
          -440,-80},{-40,-80},{-40,-60},{180,-60},{180,212},{278,212}}, color={255,
          0,255}));
  connect(and8.y, logSwi12.u1) annotation (Line(points={{101,-260},{212,-260},{212,
          178},{278,178}}, color={255,0,255}));
  connect(booRep11.y, logSwi12.u2)
    annotation (Line(points={{161,170},{278,170}}, color={255,0,255}));
  ...
  connect(lat5.y, booRep14.u)
    annotation (Line(points={{61,60},{138,60}}, color={255,0,255}));
  connect(lat9.y, booRep13.u)
    annotation (Line(points={{121,90},{138,90}}, color={255,0,255}));
  connect(booRep14.y, logSwi16.u2)
    annotation (Line(points={{161,60},{278,60}}, color={255,0,255}));
  connect(booRep13.y, logSwi18.u2)
    annotation (Line(points={{161,90},{338,90}}, color={255,0,255}));
  connect(logSwi16.y, logSwi18.u3) annotation (Line(points={{301,60},{320,60},{320,
          82},{338,82}}, color={255,0,255}));
  connect(logSwi17.y, logSwi18.u1) annotation (Line(points={{301,110},{320,110},
          {320,98},{338,98}}, color={255,0,255}));
  connect(logSwi18.y, logSwi19.u1) annotation (Line(points={{361,90},{370,90},{370,
          98},{398,98}}, color={255,0,255}));
  connect(logSwi19.y, logSwi15.u3) annotation (Line(points={{421,90},{440,90},{440,
          200},{390,200},{390,212},{398,212}}, color={255,0,255}));
  connect(booRep12.y, logSwi17.u2) annotation (Line(points={{-319,-440},{260,-440},
          {260,110},{278,110}}, color={255,0,255}));
  connect(and7.y, logSwi17.u1) annotation (Line(points={{101,-310},{220,-310},{220,
          118},{278,118}}, color={255,0,255}));
  connect(uTowSta, logSwi17.u3) annotation (Line(points={{-500,300},{-440,300},{
          -440,-80},{-40,-80},{-40,-60},{180,-60},{180,102},{278,102}}, color={255,
          0,255}));
  connect(and7.y, logSwi16.u1) annotation (Line(points={{101,-310},{220,-310},{220,
          68},{278,68}}, color={255,0,255}));
  connect(uTowSta, logSwi16.u3) annotation (Line(points={{-500,300},{-440,300},{
          -440,-80},{-40,-80},{-40,-60},{180,-60},{180,52},{278,52}}, color={255,
          0,255}));
  connect(booRep9.y, logSwi19.u2) annotation (Line(points={{-19,30},{380,30},{380,
  ...
  connect(logSwi7.y, yTowSta)
    annotation (Line(points={{421,430},{490,430}}, color={255,0,255}));
  connect(booToRea.y, mulSum.u)
    annotation (Line(points={{-399,300},{-382,300}}, color={0,0,127}));
  connect(conInt.y, intToRea1.u) annotation (Line(points={{-399,-100},{-360,-100},
          {-360,-50},{-322,-50}}, color={255,127,0}));
  connect(intEqu1.y, swi1.u2) annotation (Line(points={{-59,-140},{-10,-140},{-10,
          -100},{298,-100}}, color={255,0,255}));
  connect(intToRea1.y, swi1.u1) annotation (Line(points={{-299,-50},{280,-50},{280,
          -92},{298,-92}}, color={0,0,127}));
  connect(con3.y, swi1.u3) annotation (Line(points={{241,-400},{270,-400},{270,-108},
          {298,-108}}, color={0,0,127}));
  connect(intEqu2.y, swi2.u2) annotation (Line(points={{-59,-190},{-10,-190},{-10,
          -160},{298,-160}}, color={255,0,255}));
  connect(intToRea1.y, swi2.u1) annotation (Line(points={{-299,-50},{280,-50},{280,
          -152},{298,-152}}, color={0,0,127}));
  connect(con3.y, swi2.u3) annotation (Line(points={{241,-400},{270,-400},{270,-168},
          {298,-168}}, color={0,0,127}));
  connect(swi1.y, add2.u1) annotation (Line(points={{321,-100},{330,-100},{330,-134},
          {338,-134}}, color={0,0,127}));
  connect(swi2.y, add2.u2) annotation (Line(points={{321,-160},{330,-160},{330,-146},
          {338,-146}}, color={0,0,127}));
  connect(booRep5.y, swi3.u2) annotation (Line(points={{-19,360},{-10,360},{-10,
          -40},{360,-40},{360,-100},{398,-100}}, color={255,0,255}));
  connect(swi1.y, swi3.u1) annotation (Line(points={{321,-100},{330,-100},{330,-92},
          {398,-92}}, color={0,0,127}));
  connect(booRep2.y, swi4.u2) annotation (Line(points={{-19,250},{10,250},{10,-30},
          {368,-30},{368,-148},{398,-148}}, color={255,0,255}));
  connect(add2.y, swi4.u1)
    annotation (Line(points={{361,-140},{398,-140}}, color={0,0,127}));
  connect(swi4.y, swi3.u3) annotation (Line(points={{421,-148},{440,-148},{440,-120},
          {390,-120},{390,-108},{398,-108}}, color={0,0,127}));
  connect(swi3.y, yEnaCelInd)
    annotation (Line(points={{421,-100},{490,-100}}, color={0,0,127}));
  connect(intEqu3.y, swi6.u2) annotation (Line(points={{-59,-240},{-10,-240},{-10,
          -210},{298,-210}}, color={255,0,255}));
  connect(intToRea1.y, swi6.u1) annotation (Line(points={{-299,-50},{280,-50},{280,
          -202},{298,-202}}, color={0,0,127}));
  connect(intEqu4.y, swi5.u2) annotation (Line(points={{-59,-290},{-10,-290},{-10,
          -330},{298,-330}}, color={255,0,255}));
  connect(intToRea1.y, swi5.u1) annotation (Line(points={{-299,-50},{280,-50},{280,
          -322},{298,-322}}, color={0,0,127}));
  connect(con3.y, swi6.u3) annotation (Line(points={{241,-400},{270,-400},{270,-218},
          {298,-218}}, color={0,0,127}));
  connect(con3.y, swi5.u3) annotation (Line(points={{241,-400},{270,-400},{270,-338},
          {298,-338}}, color={0,0,127}));
  connect(swi6.y, add1.u1) annotation (Line(points={{321,-210},{330,-210},{330,-244},
          {338,-244}}, color={0,0,127}));
  connect(swi5.y, add1.u2) annotation (Line(points={{321,-330},{330,-330},{330,-256},
          {338,-256}}, color={0,0,127}));
  connect(booRep8.y, swi8.u2) annotation (Line(points={{-19,140},{190,140},{190,
          -20},{374,-20},{374,-210},{398,-210}}, color={255,0,255}));
  connect(swi6.y, swi8.u1) annotation (Line(points={{321,-210},{330,-210},{330,-202},
          {398,-202}}, color={0,0,127}));
  connect(swi7.y, swi8.u3) annotation (Line(points={{421,-258},{440,-258},{440,-230},
          {388,-230},{388,-218},{398,-218}}, color={0,0,127}));
  connect(con3.y, swi4.u3) annotation (Line(points={{241,-400},{270,-400},{270,-180},
          {360,-180},{360,-156},{398,-156}}, color={0,0,127}));
  connect(booRep9.y, swi7.u2) annotation (Line(points={{-19,30},{230,30},{230,-10},
          {380,-10},{380,-258},{398,-258}}, color={255,0,255}));
  connect(add1.y, swi7.u1)
    annotation (Line(points={{361,-250},{398,-250}}, color={0,0,127}));
  connect(con3.y, swi7.u3) annotation (Line(points={{241,-400},{380,-400},{380,-266},
          {398,-266}}, color={0,0,127}));
  connect(swi8.y, yDisCelInd)
    annotation (Line(points={{421,-210},{490,-210}}, color={0,0,127}));

  connect(lat6.y, logSwi20.u2) annotation (Line(points={{121,430},{130,430},{130,
          380},{398,380}}, color={255,0,255}));
  connect(and2.y, logSwi20.u1) annotation (Line(points={{-419,-360},{-380,-360},
          {-380,-380},{234,-380},{234,388},{398,388}}, color={255,0,255}));
  connect(lat2.y, logSwi20.u3) annotation (Line(points={{61,400},{100,400},{100,
          372},{398,372}}, color={255,0,255}));
  connect(lat7.y, logSwi21.u2) annotation (Line(points={{121,310},{130,310},{130,
          260},{398,260}}, color={255,0,255}));
  connect(and2.y, logSwi21.u1) annotation (Line(points={{-419,-360},{-380,-360},
          {-380,-380},{234,-380},{234,268},{398,268}}, color={255,0,255}));
  connect(lat3.y, logSwi21.u3) annotation (Line(points={{61,280},{100,280},{100,
          252},{398,252}}, color={255,0,255}));
  connect(logSwi20.y, or1.u1)
    annotation (Line(points={{421,380},{450,380}}, color={255,0,255}));
  connect(logSwi21.y, or1.u2) annotation (Line(points={{421,260},{430,260},{430,
          372},{450,372}}, color={255,0,255}));
  connect(or1.y, yEnaCel)
    annotation (Line(points={{473,380},{490,380}}, color={255,0,255}));
  connect(lat8.y, logSwi22.u2) annotation (Line(points={{121,200},{130,200},{130,
          150},{398,150}}, color={255,0,255}));
  connect(and1.y, logSwi22.u1) annotation (Line(points={{-419,-440},{-380,-440},
          {-380,-460},{254,-460},{254,158},{398,158}}, color={255,0,255}));
  connect(lat4.y, logSwi22.u3) annotation (Line(points={{61,170},{100,170},{100,
          142},{398,142}}, color={255,0,255}));
  connect(lat9.y, logSwi23.u2) annotation (Line(points={{121,90},{130,90},{130,40},
          {398,40}}, color={255,0,255}));
  connect(and1.y, logSwi23.u1) annotation (Line(points={{-419,-440},{-380,-440},
          {-380,-460},{254,-460},{254,48},{398,48}}, color={255,0,255}));
  connect(lat5.y, logSwi23.u3) annotation (Line(points={{61,60},{100,60},{100,32},
          {398,32}}, color={255,0,255}));
  connect(logSwi22.y, or4.u1)
    annotation (Line(points={{421,150},{450,150}}, color={255,0,255}));
  connect(logSwi23.y, or4.u2) annotation (Line(points={{421,40},{430,40},{430,142},
          {450,142}}, color={255,0,255}));
  connect(or4.y, yDisCel)
    annotation (Line(points={{473,150},{490,150}}, color={255,0,255}));
annotation (
  defaultComponentName="cooTowSta",
  Icon(graphics={
        Text(
