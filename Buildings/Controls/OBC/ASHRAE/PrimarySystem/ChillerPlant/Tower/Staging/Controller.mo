...
equation
  ...
  connect(enaCel.y, towCelStaPro.uCelInd) annotation (Line(points={{-39,50},{-26,
          50},{-26,-2},{-2,-2}},   color={255,127,0}));
  ...
  connect(booRep1.y, logSwi1.u2)
    annotation (Line(points={{21,50},{58,50}}, color={255,0,255}));
  ...
  connect(logSwi1.y, yTowSta)
    annotation (Line(points={{81,50},{110,50}}, color={255,0,255}));
  connect(enaTowCel.yDisCelInd, disCel.u) annotation (Line(points={{-39,101},{-30,
          101},{-30,0},{-76,0},{-76,-80},{-62,-80}}, color={0,0,127}));
  connect(disCel.y, intEqu.u1) annotation (Line(points={{-39,-80},{-30,-80},{-30,
          -100},{-22,-100}}, color={255,127,0}));
  connect(conInt.y, intEqu.u2) annotation (Line(points={{-39,-110},{-30,-110},{-30,
          -108},{-22,-108}}, color={255,127,0}));
  connect(intEqu.y, swi.u2)
    annotation (Line(points={{1,-100},{18,-100}}, color={255,0,255}));
  connect(con9.y, swi.u1) annotation (Line(points={{1,-60},{10,-60},{10,-92},{18,
          -92}}, color={0,0,127}));
  connect(uIsoVal, swi.u3) annotation (Line(points={{-120,-130},{10,-130},{10,-108},
          {18,-108}}, color={0,0,127}));
  connect(swi.y, swi1.u1) annotation (Line(points={{41,-100},{50,-100},{50,8},{58,
          8}},       color={0,0,127}));
  connect(booRep1.y, swi1.u2) annotation (Line(points={{21,50},{40,50},{40,0},{58,
          0}},       color={255,0,255}));
