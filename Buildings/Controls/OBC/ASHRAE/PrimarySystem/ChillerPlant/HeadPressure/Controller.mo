...
block Controller "Controller for head pressure control"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TConWatRet if
       not hasHeaPreConSig
    "Measured condenser water return temperature"
    annotation (Placement(transformation(extent={{-140,70},{-100,110}}),
      iconTransformation(extent={{-120,50},{-100,70}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TChiWatSup if
       not hasHeaPreConSig
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uHeaPreCon if
       hasHeaPreConSig
...
equation
  ...
  connect(chiHeaPreLoo.TChiWatSup, TChiWatSup) annotation (Line(points={{-22,82},
          {-40,82},{-40,60},{-120,60}}, color={0,0,127}));
  connect(chiHeaPreLoo.uHeaPreEna, uHeaPreEna) annotation (Line(points={{-22,98},
          {-80,98},{-80,120},{-120,120}}, color={255,0,255}));
  connect(chiHeaPreLoo.yHeaPreCon, noWSE.uHeaPreCon) annotation (Line(points={{1,90},{
          20,90},{20,50},{38,50}},    color={0,0,127}));
  connect(chiHeaPreLoo.yHeaPreCon, withWSE.uHeaPreCon) annotation (Line(points={{1,90},{
          20,90},{20,-5},{39,-5}},         color={0,0,127}));
  connect(uHeaPreEna, noWSE.uHeaPreEna) annotation (Line(points={{-120,120},{-80,
          120},{-80,42},{38,42}}, color={255,0,255}));
  connect(withWSE.uMaxTowSpeSet, uMaxTowSpeSet) annotation (Line(points={{39,-2},
          {0,-2},{0,30},{-120,30}},     color={0,0,127}));
  connect(withWSE.uConWatPumSpe, uConWatPumSpe) annotation (Line(points={{39,-8},
          {-40,-8},{-40,0},{-120,0}}, color={0,0,127}));
  connect(withWSE.uConWatPumSpe_nominal, uConWatPumSpe_nominal) annotation (
      Line(points={{39,-10},{-40,-10},{-40,-30},{-120,-30}}, color={0,0,127}));
  connect(withWSE.uWSE, uWSE) annotation (Line(points={{39,-12},{-20,-12},{-20,-60},
          {-120,-60}}, color={255,0,255}));
  connect(withWSE.uHeaPreConVal, uHeaPreConVal) annotation (Line(points={{39,-15},
          {0,-15},{0,-90},{-120,-90}},     color={0,0,127}));
  connect(uHeaPreEna, withWSE.uHeaPreEna) annotation (Line(points={{-120,120},{-80,
          120},{-80,-18},{39,-18}}, color={255,0,255}));
  connect(uHeaPreEna, swi.u2) annotation (Line(points={{-120,120},{-80,120},{-80,
          -110},{-22,-110}}, color={255,0,255}));
  connect(uHeaPreCon, swi.u1) annotation (Line(points={{-120,-120},{-70,-120},{-70,
          -102},{-22,-102}}, color={0,0,127}));
  connect(con.y, swi.u3) annotation (Line(points={{-39,-130},{-30,-130},{-30,-118},
          {-22,-118}}, color={0,0,127}));
  connect(swi.y, noWSE.uHeaPreCon) annotation (Line(points={{1,-110},{20,-110},{
          20,50},{38,50}}, color={0,0,127}));
  connect(swi.y, withWSE.uHeaPreCon) annotation (Line(points={{1,-110},{20,-110},
          {20,-5},{39,-5}}, color={0,0,127}));
  connect(noWSE.yMaxTowSpeSet, yMaxTowSpeSet)
    annotation (Line(points={{61,56},{110,56}}, color={0,0,127}));
  connect(noWSE.yHeaPreConVal, yHeaPreConVal) annotation (Line(points={{61,44},{
          90,44},{90,20},{110,20}}, color={0,0,127}));
  connect(withWSE.yHeaPreConVal, yHeaPreConVal) annotation (Line(points={{61,-16},
          {90,-16},{90,20},{110,20}}, color={0,0,127}));
  connect(withWSE.yMaxTowSpeSet, yMaxTowSpeSet) annotation (Line(points={{61,-4},
          {80,-4},{80,56},{110,56}}, color={0,0,127}));
  connect(withWSE.yConWatPumSpe, yConWatPumSpe) annotation (Line(points={{61,-10},
          {80,-10},{80,-40},{110,-40}}, color={0,0,127}));
