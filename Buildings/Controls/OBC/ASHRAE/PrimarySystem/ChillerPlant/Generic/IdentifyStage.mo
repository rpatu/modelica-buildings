...
block IdentifyStage "Sequence for identifying current plant stage"
  ...
  parameter Boolean ponChiFlg[nChi]={false, false}
    "Flag to indicate if it is pony chiller"
...
equation
  connect(uChi, enaPonChi.u1)
    annotation (Line(points={{-180,130},{-140,130},{-140,30},{-22,30}}, color={255,0,255}));
  ...
  connect(uChi, enaRegChi.u1)
    annotation (Line(points={{-180,130},{-140,130},{-140,-10},{-22,-10}}, color={255,0,255}));
  ...
  connect(uChi, booToInt.u)
    annotation (Line(points={{-180,130},{-122,130}}, color={255,0,255}));
  connect(mulSumInt.y, intToRea1.u)
    annotation (Line(points={{-58.3,130},{-42,130}}, color={255,127,0}));
  ...
  connect(intToRea1.y, swi3.u1)
    annotation (Line(points={{-19,130},{40,130},{40,98},{58,98}}, color={0,0,127}));
  ...
  connect(noPon.y, swi3.u2)
    annotation (Line(points={{-19,90},{58,90}}, color={255,0,255}));
  connect(zer1.y, swi3.u3)
    annotation (Line(points={{-99,60},{40,60},{40,82},{58,82}}, color={0,0,127}));
  connect(mulSumInt.y, intGreThr.u)
    annotation (Line(points={{-58.3,130},{-50,130},{-50,160},{-42,160}},
      color={255,127,0}));
  connect(intGreThr.y, or2.u2)
    annotation (Line(points={{-19,160},{0,160},{0,172},{38,172}}, color={255,0,255}));
  connect(uWSE, or2.u1)
    annotation (Line(points={{-180,-60},{-144,-60},{-144,180},{38,180}}, color={255,0,255}));
