within Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWaterP;
...
protected
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWaterP.Subsequences.EnableLead_headered
    enaLeaHeaPum if isheadered
    "Enable lead pumps for plants with headered condenser water pump"
    annotation (Placement(transformation(extent={{40,70},{60,90}})));
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWaterP.Subsequences.EnableLead_dedicated
    enaLeaDedPum if not isheadered
    "Enable lead pumps for plants with dedicated condenser water pump"
    annotation (Placement(transformation(extent={{40,30},{60,50}})));
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWaterP.Subsequences.Speed_noWSE
    pumSpeNoWse if not haveWSE
    "Operating speed of condenser water pump for plants without waterside economizer"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWaterP.Subsequences.Speed_haveWSE
