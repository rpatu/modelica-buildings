within Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWaterP.Subsequences;
...
<p>
2. The lead condenser water pump shall be enabled when any chiller 
<code>uChiConIsoVal</code> or water side economizer <code>uWseConIsoVal</code> 
condenser water isolation valve is commanded open. It shall be disabled when 
