...
protected
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.UpProcess.Subsequences.ResetMinBypassSetpoint
    minBypRes(
    final aftByPasSetTim=aftByPasSetTim,
    final minFloDif=minFloDif)
    "Slowly change the minimum flow bypass setpoint"
    annotation (Placement(transformation(extent={{60,90},{80,110}})));
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.UpProcess.Subsequences.EnableHeadControl
    enaHeaCon(
    final nChi=nChi,
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.UpProcess.Subsequences.EnableChiIsoVal
    enaChiIsoVal(
    final nChi=nChi,
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.UpProcess.Subsequences.DisableChiller disChi(
    final nChi=nChi,
...
equation
  ...
  connect(con3.y, minBypSet.uStaUp)
    annotation (Line(points={{-79,70},{-60,70},{-60,58},{-2,58}},
      color={255,0,255}));
  ...
  connect(minBypSet.uStaDow, uStaDow)
    annotation (Line(points={{-2,42},{-140,42},{-140,190},{-180,190}},
      color={255,0,255}));
  connect(minBypSet.uOnOff, uOnOff)
    annotation (Line(points={{-2,46},{-80,46},{-80,20},{-180,20}},
      color={255,0,255}));
  ...
  connect(booRep4.y, chiDem.u2) annotation (Line(points={{81,20},{120,20},{120,140},
  ...
  connect(booRep4.y, heaPreCon.u2) annotation (Line(points={{81,20},{120,20},{120,
          -20},{138,-20}}, color={255,0,255}));
  ...
  connect(booRep4.y, chiWatIsoVal.u2) annotation (Line(points={{81,20},{120,20},
  ...
  connect(chiDem.y, yChiDem)
    annotation (Line(points={{161,140},{190,140}}, color={0,0,127}));
  connect(heaPreCon.y, yChiHeaCon)
    annotation (Line(points={{161,-20},{190,-20}}, color={255,0,255}));
  connect(chiWatIsoVal.y, yChiWatIsoVal)
    annotation (Line(points={{161,-70},{190,-70}}, color={0,0,127}));
  ...
  connect(not1.y, and2.u2) annotation (Line(points={{81,-180},{100,-180},{100,-200},
          {-120,-200},{-120,182},{-102,182}}, color={255,0,255}));
