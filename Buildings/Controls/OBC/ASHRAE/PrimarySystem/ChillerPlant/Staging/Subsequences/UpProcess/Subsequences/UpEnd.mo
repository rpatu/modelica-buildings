...
protected
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.UpProcess.Subsequences.EnableChiIsoVal disChiIsoVal(
    final nChi=nChi,
    final iniValPos=1,
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.UpProcess.Subsequences.EnableHeadControl disHeaCon(
    final nChi=nChi,
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.UpProcess.Subsequences.ResetMinBypassSetpoint minBypSet1(
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.UpProcess.Subsequences.EnableChiller enaChi(
    final nChi=nChi,
...
equation
  ...
  connect(lesEquThr.y, and4.u2) annotation (Line(points={{-59,20},{0,20},{0,32},
  ...
  connect(con3.y, minBypSet.uStaUp) annotation (Line(points={{-39,-136},{0,-136},
          {0,-120},{78,-120}},   color={255,0,255}));
  connect(con3.y, minBypSet.uOnOff) annotation (Line(points={{-39,-136},{0,-136},
          {0,-132},{78,-132}},   color={255,0,255}));
  connect(con3.y, minBypSet.uStaDow) annotation (Line(points={{-39,-136},{78,-136}},
                                 color={255,0,255}));
  ...
  connect(booRep4.y, logSwi3.u2) annotation (Line(points={{-39,60},{50,60},{50,-50},
          {158,-50}},        color={255,0,255}));
  connect(booRep4.y, chiWatIso.u2)
    annotation (Line(points={{-39,60},{158,60}},   color={255,0,255}));
  ...
  connect(con2.y, logSwi4.u1) annotation (Line(points={{-79,-30},{20,-30},{20,-152},
  ...
  connect(chiWatByp.y, yChiWatBypSet)
    annotation (Line(points={{181,-110},{210,-110}}, color={0,0,127}));
  connect(not2.y, logSwi5.u2) annotation (Line(points={{-139,100},{-130,100},{-130,
          -230},{158,-230}}, color={255,0,255}));
  connect(logSwi4.y, logSwi5.u3) annotation (Line(points={{181,-160},{190,-160},
          {190,-210},{140,-210},{140,-238},{158,-238}}, color={255,0,255}));
  connect(logSwi5.y, yEndSta)
    annotation (Line(points={{181,-230},{210,-230}}, color={255,0,255}));
