...
protected
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.MinimumFlowBypass.Subsequences.FlowSetpoint minBypSet(
    ...
    annotation (Placement(transformation(extent={{80,-218},{100,-198}})));
...
equation
  ...
  connect(con3.y, minBypSet.uStaUp) annotation (Line(points={{-39,-200},{78,-200}},
                                 color={255,0,255}));
  connect(con3.y, minBypSet.uOnOff) annotation (Line(points={{-39,-200},{20,-200},
          {20,-212},{78,-212}},  color={255,0,255}));
  connect(con3.y, minBypSet.uStaDow) annotation (Line(points={{-39,-200},{20,-200},
          {20,-216},{78,-216}},  color={255,0,255}));
  connect(uSta, minBypSet.uSta)
    annotation (Line(points={{-220,-220},{-20,-220},{-20,-208},{78,-208}},
      color={255,127,0}));
  connect(disHeaCon.yEnaHeaCon, minBypSet.uUpsDevSta)
    annotation (Line(points={{101,-144},{120,-144},{120,-190},{40,-190},{40,-204},
          {78,-204}},       color={255,0,255}));
  ...
  connect(minBypSet.yChiWatBypSet, minBypSet1.VBypas_setpoint)
    annotation (Line(points={{101,-208},{120,-208},{120,-228},{60,-228},{60,-268},
          {78,-268}},       color={0,0,127}));
  ...
  connect(minBypSet.yChiWatBypSet, chiWatByp.u3) annotation (Line(points={{101,-208},
          {120,-208},{120,-198},{158,-198}}, color={0,0,127}));
