...
equation
  ...
  connect(intToRea.y, nexEnaChi.u)
    annotation (Line(points={{-39,200},{58,200}}, color={0,0,127}));
  ...
  connect(nexEnaChi.y, reaToInt1.u)
    annotation (Line(points={{81,200},{98,200}}, color={0,0,127}));
  ...
  connect(mulSum.y, swi.u3)
    annotation (Line(points={{-119,160},{-100,160},{-100,122},{-42,122}},
      color={0,0,127}));
  connect(booToRea.y, mulSum.u)
    annotation (Line(points={{-159,160},{-142,160}}, color={0,0,127}));
  connect(reaToInt1.y, yNexEnaChi)
    annotation (Line(points={{121,200},{210,200}}, color={255,127,0}));
  connect(uStaDow, swi1.u2)
    annotation (Line(points={{-222,-60},{-42,-60}}, color={255,0,255}));
  connect(intEqu.y, and2.u2)
    annotation (Line(points={{-119,20},{-60,20},{-60,52},{-42,52}},
      color={255,0,255}));
  connect(uStaUp, and2.u1)
    annotation (Line(points={{-220,130},{-120,130},{-120,60},{-42,60}},
      color={255,0,255}));
  connect(intToRea.y, disSmaChi.u)
    annotation (Line(points={{-39,200},{0,200},{0,110},{58,110}},
      color={0,0,127}));
  connect(mulSum.y, reaToInt.u)
    annotation (Line(points={{-119,160},{-100,160},{-100,80},{38,80}},
      color={0,0,127}));
  connect(reaToInt.y, disSmaChi.index)
    annotation (Line(points={{61,80},{70,80},{70,98}}, color={255,127,0}));
  connect(and2.y, swi3.u2)
    annotation (Line(points={{-19,60},{118,60}}, color={255,0,255}));
  connect(con7.y, swi3.u3)
    annotation (Line(points={{81,40},{100,40},{100,52},{118,52}}, color={0,0,127}));
  connect(disSmaChi.y, swi3.u1)
    annotation (Line(points={{81,110},{100,110},{100,68},{118,68}}, color={0,0,127}));
  connect(swi3.y, reaToInt2.u)
    annotation (Line(points={{141,60},{158,60}}, color={0,0,127}));
  connect(swi.y, reaToInt3.u)
    annotation (Line(points={{-19,130},{18,130}}, color={0,0,127}));
  connect(reaToInt3.y, nexEnaChi.index)
    annotation (Line(points={{41,130},{70,130},{70,188}}, color={255,127,0}));
  connect(reaToInt2.y, yDisSmaChi)
    annotation (Line(points={{181,60},{210,60}}, color={255,127,0}));
  connect(intToRea.y, nexDisChi.u)
    annotation (Line(points={{-39,200},{0,200},{0,-30},{58,-30}}, color={0,0,127}));
  connect(swi1.y, reaToInt4.u)
    annotation (Line(points={{-19,-60},{18,-60}}, color={0,0,127}));
  connect(reaToInt4.y, nexDisChi.index)
    annotation (Line(points={{41,-60},{70,-60},{70,-42}}, color={255,127,0}));
  connect(conInt.y, intEqu.u1)
    annotation (Line(points={{-159,40},{-150,40},{-150,20},{-142,20}},
      color={255,127,0}));
