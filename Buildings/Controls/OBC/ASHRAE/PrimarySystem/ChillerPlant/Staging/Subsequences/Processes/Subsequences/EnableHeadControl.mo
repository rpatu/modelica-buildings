...
equation
  ...
  connect(booToRea.y, triSam.u)
    annotation (Line(points={{-99,-70},{-60,-70},{-60,-90},{-22,-90}},
      color={0,0,127}));
  connect(edg.y, and2.u1)
    annotation (Line(points={{-99,120},{-80,120},{-80,100},{-130,100},{-130,80},
     {-122,80}}, color={255,0,255}));
  connect(uStaCha, and2.u2)
    annotation (Line(points={{-160,72},{-122,72}}, color={255,0,255}));
  connect(and2.y, lat.u)
    annotation (Line(points={{-99,80},{-61,80}}, color={255,0,255}));
  connect(and2.y, booRep.u)
    annotation (Line(points={{-99,80},{-80,80},{-80,-120},{-62,-120}},
      color={255,0,255}));
  ...
  connect(greEquThr.y, yChiHeaCon)
    annotation (Line(points={{201,-10},{230,-10}}, color={255,0,255}));
  connect(not2.y, booRep2.u)
    annotation (Line(points={{1,-60},{18,-60}}, color={255,0,255}));
  connect(booRep2.y, swi1.u2)
    annotation (Line(points={{41,-60},{78,-60}}, color={255,0,255}));
  connect(triSam.y, swi1.u3)
    annotation (Line(points={{1,-90},{60,-90},{60,-68},{78,-68}},
      color={0,0,127}));
  connect(swi1.y, swi.u3)
    annotation (Line(points={{101,-60},{120,-60},{120,-18},{138,-18}},
      color={0,0,127}));
  connect(lat.y, not2.u)
    annotation (Line(points={{-39,80},{-30,80},{-30,-60},{-22,-60}},
      color={255,0,255}));
  connect(uNexChaChi, intRep.u)
    annotation (Line(points={{-160,-10},{-122,-10}}, color={255,127,0}));
  connect(intRep.y, intEqu.u1)
    annotation (Line(points={{-99,-10},{-62,-10}}, color={255,127,0}));
  connect(booToRea.y, swi1.u1)
    annotation (Line(points={{-99,-70},{-60,-70},{-60,-40},{50,-40},{50,-52},
      {78,-52}}, color={0,0,127}));
  connect(intEqu.y, swi2.u2)
    annotation (Line(points={{-39,-10},{78,-10}}, color={255,0,255}));
  connect(swi2.y, swi.u1)
    annotation (Line(points={{101,-10},{112,-10},{112,-2},{138,-2}},
      color={0,0,127}));
  connect(triSam.y, swi2.u3)
    annotation (Line(points={{1,-90},{60,-90},{60,-18},{78,-18}},
      color={0,0,127}));
  connect(con1.y, logSwi.u1)
    annotation (Line(points={{-39,50},{-20,50},{-20,38},{-2,38}},
      color={255,0,255}));
  ...
  connect(booRep3.y, booToRea1.u)
    annotation (Line(points={{61,30},{78,30}}, color={255,0,255}));
