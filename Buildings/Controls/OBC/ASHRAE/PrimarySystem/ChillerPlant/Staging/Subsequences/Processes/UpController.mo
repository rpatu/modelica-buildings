...
protected
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.Processes.Subsequences.UpEnd
    endUp(
    final nChi=nChi,
    final nSta=nSta,
...
equation
  ...
  connect(chiDemRed.yChiDem, yChiDem) annotation (Line(points={{-59,174},{100,174},
          {100,180},{250,180}}, color={0,0,127}));
